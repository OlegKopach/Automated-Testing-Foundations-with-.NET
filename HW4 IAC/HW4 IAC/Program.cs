namespace HW4IAC
{
    ...
    {
        Coordinate CurrentPoint = new();//текущее положение
        double Speed = 20;
        public void FlyTo(Coordinate point)
        {
            if (FlyUtils.CalculateDistance(CurrentPoint, point) > 10) // Дополнительное ограничение мах. дальность полета птицы "Воробей" без остановки в км. 
            {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Drone dron = new(40, 1, 10);

            Coordinate coordinate = new(58, 58, 58);
            Coordinate coordinate2 = new(69, 69, 70);
